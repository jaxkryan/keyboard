        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__Product__brandId__5AEE82B9",
                        column: x => x.brandId,
                        principalTable: "Brand",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK__Product__categor__59FA5E80",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    shipStreet = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: true),
                    shipCity = table.Column<string>(type: "varchar(30)", unicode: false, maxLength: 30, nullable: true),
                    shipProvince = table.Column<string>(type: "varchar(30)", unicode: false, maxLength: 30, nullable: true),
                    shipCountry = table.Column<string>(type: "varchar(30)", unicode: false, maxLength: 30, nullable: true),
                    shipEmail = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: true),
                    shipPhone = table.Column<string>(type: "varchar(15)", unicode: false, maxLength: 15, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__Order__userId__5BE2A6F2",
                        column: x => x.userId,
                        principalTable: "User",
                        principalColumn: "id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__CartItem__B905615191E0496C", x => new { x.productId, x.cartId });
                    table.ForeignKey(
                        name: "FK__CartItem__cartId__5FB337D6",
                        column: x => x.cartId,
                        principalTable: "Cart",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK__CartItem__produc__60A75C0F",
